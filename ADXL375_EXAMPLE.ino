...
void setup(void)
{
  ...
  y = accel.getY();
  z = accel.getZ();
  Serial.print("Raw X: "); Serial.print(x,2); Serial.print("  ");
  Serial.print("Y: "); Serial.print(y,2); Serial.print("  ");
  Serial.print("Z: "); Serial.print(z,2); Serial.print("  ");Serial.println(" counts");
...
void loop(void)
{
  ...
  float xR = (accel.getX() *49)/100;
  float yR= (accel.getY() *49)/100;
  float zR = (accel.getZ() *49)/100;
  float shk = sqrt(xR*xR+yR*yR+zR*zR);

  Serial.print("Raw X: "); Serial.print(xR); Serial.print("  ");
  Serial.print("Y: "); Serial.print(yR); Serial.print("  ");
  Serial.print("Z: "); Serial.print(zR); Serial.print("  ");
  Serial.print("Shock: "); Serial.print(shk); Serial.print("  ");
